...
<html>
    ...
    <body>
        <header style="display: grid; justify-content: space-between; grid-template-columns: repeat(4, 25%);">
            ...
            <a style="text-align: center" href="preference.html">Préférences</a>
        </header>
        <main>
            <?php
        ...
        <footer>
            <p style="border: 1px solid black;text-align:right;padding-right:1em;">
                Site de covoiturage de Tristan Dessis-Geay
            </p>
        </footer>
    </body>
</html>